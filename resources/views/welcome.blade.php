                        ...
                        <div class="announcement-posted">
                            <div class="post-container">
                                <div class="block">
                                    ...
                                    <div>
                                        <div class="post-title"><a href="#">Post Title</a> <span class="post-date">On June 7, 2018</span></div>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi voluptate iure nostrum debitis quae nihil, id fugiat consequatur... <a href="#" class="readmore">Read more</a></p>
                                    </div>
                                </div>
                                <hr>
                            </div>
                    ...
                    <div id="bulletin">
                        <div class="bulletin-container">
                            ...
                            <ul class="bulletin-post-list">
                                <li class="slide-right-bg"><a href="#">Lorem ipsum dolor sit amet, consectetur.</a></li>
                                <li class="slide-right-bg"><a href="#">Lorem ipsum dolor sit amet, consectetur.</a></li>
                                <li class="slide-right-bg"><a href="#">Lorem ipsum dolor sit amet, consectetur.</a></li>
                                <li class="slide-right-bg"><a href="#">Lorem ipsum dolor sit amet, consectetur.</a></li>
                                <li class="slide-right-bg"><a href="#">Lorem ipsum dolor sit amet, consectetur.</a></li>
